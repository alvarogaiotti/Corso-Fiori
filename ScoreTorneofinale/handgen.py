...
predeal = {
Seat['N']: H("742 KQJ6 K2 8653"),
Seat['S']: H("AQ8 743 A743 AK4"),
Seat['W']: H("95 A985 956 QJT9"),
Seat['E']: H("KJT63 T2 QJT8 72"),}
...
predeal = {
Seat['N']: H("K952 853 AQ5 K65"),
Seat['S']: H("QJT63 A62 K6 QJ3"),
Seat['W']: H("A4 KQJ4 J984 984"),
Seat['E']: H("87 T97 T732 AT72"),}
dealer = Deal.prepare(predeal)
print(f'[Board "4"]\n{dealer()._pbn_str()}')
...
predeal = {
Seat['N']: H("K8 J96 T6432 832"),
Seat['W']: H("Q76 T3 J7 KQT964"),
Seat['E']: H("J543 AK54 KQ85 J"),
Seat['S']: H("AT92 Q872 A9 A75"),}
dealer = Deal.prepare(predeal)
print(f'[Board "6"]\n{dealer()._pbn_str()}')
...
predeal = {
Seat['N']: H("KQT A62 9875 A98"),
Seat['W']: H("97432 J93 Q643 3"),
Seat['E']: H("J865 T AJ KJT542"),
Seat['S']: H("A KQ8754 KT2 Q76"),}
dealer = Deal.prepare(predeal)
print(f'[Board "8"]\n{dealer()._pbn_str()}')
...
predeal = {
Seat['E']: H("QT94 93 QJ5 J653"),
Seat['N']: H("AJ76 QJT5 87 KQ8"),
Seat['S']: H("8532 876 63 AT72"),
Seat['W']: H("K AK42 AKT942 94"),}
dealer = Deal.prepare(predeal)
print(f'[Board "10"]\n{dealer()._pbn_str()}')
