...
\begin{titlingpage} % Suppresses headers and footers on the title page
    ...
    {\large Circolo Bridge Pordenone ~~\raisebox{-1.3em}{\includegraphics[scale=.3, trim={0 7.4cm 21.7cm 0},
    clip]{logobpn.jpg}}} % Publisher and logo
...
\tcblistof[\chapter*]{regole}{Lista delle Regole}
