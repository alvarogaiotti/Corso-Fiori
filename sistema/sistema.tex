...
\begin{large}
    Quinta nobile, quadri quarte. 1\SA 15--17. 2\SA\ 22--23. No transfer.
\end{large}
...
\begin{large}
    \begin{bidtable}
        ...
        2\Cl\>\> 2+\Cl, 20+ punti, naturale sbilanciata o bilanciata 23+, forzante\\
...
\begin{bidtable}
    1\Cl/\Di--\+\\
    1\Di,\He,\Sp,\SA \> \> Naturali, 5+ punti\\
...
\begin{landscape}
    ...
    \begin{tikzpicture}[node distance=2cm,
        ...
        \draw[-{Circle[fill=red!80]}, color=red!80]      (apri2.south west) ++(1.2mm,.1mm) -- ++(-2.9,0) -- ++(0,-7.5) --(5p1.east);
    \end{tikzpicture}
\end{landscape}
\end{document}
